...
def payment_success_view(request):
    # Ici, nous passerons la commande | après paiement réussi
    # nous allons chercher le mobile, l'adresse, l'e-mail du client
    # nous allons récupérer l'identifiant du produit à partir des cookies, puis les détails respectifs de la base de données
    # alors nous créerons des objets de commande et les stockerons dans la base de données
    # après cela, nous supprimerons les cookies car après la commande passée ... le panier devrait être vide
